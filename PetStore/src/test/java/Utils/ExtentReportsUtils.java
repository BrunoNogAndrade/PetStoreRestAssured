...
public class ExtentReportsUtils {
    ...
    public static void addRestTestInfo(String url, String requestService, String method, Map<String, String> headers, Map<String, String> cookies, Map<String, String> queryParameters, Object jsonBody, AuthenticationType authenticationType, String authenticatorUser, String authenticatorPassword, Response response) {
    ...
    public static void addTestInfo(String url, Map<String, String> headers, Map<String, String> cookies, String xmlBody, AuthenticationType authenticationType, String authenticatorUser, String authenticatorPassword, Response response){
        String allHeaders = "";
        String allCookies = "";
        String allResponseHeaders = "";
        ...
        switch (result.getStatus()) {
            case ITestResult.FAILURE:
                ...
                if(!result.getThrowable().toString().contains("AssertionError")) {
                    TEST.log(Status.ERROR, "Test Result: " + Status.ERROR + "<pre>" + "Message: " + result.getThrowable().toString() + "</pre>" + "<pre>" + "Stack Trace: " + GeneralUtils.getAllStackTrace(result) + "</pre>");
                }else {
